  ...
  for p = 1:length(expParam.session.(sesName).phases)
    ...
    switch phaseName
      ...
      case {'recog'}
        ...
        [cfg,expParam,f1Stim,f2Stim] = et_processStims_recog(cfg,expParam,sesName,phaseName,recogCount,f1Stim,f2Stim);
