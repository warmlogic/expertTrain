...
for b = 1:phaseCfg.nBlocks
  ...
  if runRecogStudy
    ...
    fprintf(plf,'!!! Start of %s %s (%d) (%s study) %s %s\n',sesName,phaseName,phaseCount,mfilename,thisDate,startTime);
    ...
    for i = trialNum:length(blockStimTex)
      ...
      fprintf(logFile,'%f\t%s\t%s\t%s\t%d\t%d\t%s\t%i\t%i\t%s\t%s\t%i\t%i\t%i\t%i\n',...
        study_imgOn{b}(i),...
        expParam.subject,...
        sesName,...
        phaseName,...
      ...
      % Write study stimulus presentation to file:
      fprintf(plf,'%f\t%s\t%s\t%s\t%d\t%d\t%s\t%i\t%i\t%s\t%s\t%i\t%i\t%i\t%i\n',...
        study_imgOn{b}(i),...
        expParam.subject,...
        sesName,...
        phaseName,...
  ...
  fprintf(plf,'!!! Start of %s %s (%d) (%s test) %s %s\n',sesName,phaseName,phaseCount,mfilename,thisDate,startTime);
  ...
  for i = trialNum:length(blockStimTex)
    ...
    fprintf(logFile,'%f\t%s\t%s\t%s\t%d\t%d\t%s\t%i\t%i\t%s\t%s\t%i\t%i\t%i\t%i\t%s\t%s\t%i\t%i\n',...
      endRT{b}(i),...
      expParam.subject,...
      sesName,...
      phaseName,...
