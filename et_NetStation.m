function [status, error] = et_NetStation(varargin)
%
% et_NetStation - Basic control of the EGI/NetStation EEG recording system via
...
%   double, and char, as described in the Net Staiton GES Hardware
%   Technical Manual, Appendix G).
%
%
% General syntax
%
...
warning('This function (%s) is no longer necessary. Use the version of NetStation.m that comes with Psychtoolbox (note the different in name).',mfilename);
