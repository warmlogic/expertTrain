...
if ismember(matchPhaseStr,expParam.session.(sesName).phases)
...
if ismember(recogPhaseStr,expParam.session.(sesName).phases)
...
if ismember(viewnamePhaseStr,expParam.session.(sesName).phases)
...
if ismember(namePhaseStr,expParam.session.(sesName).phases)
