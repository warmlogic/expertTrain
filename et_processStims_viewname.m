...
%     % add them to the viewing list
%     if cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerView > 1
%       %fprintf('\view f1: block %d, species %d, exemplar%s\n',b,cfg.stim.(sesName).(phaseName)(phaseCount).blockSpeciesOrder{b}(s),...
%       %  sprintf(repmat(' %d',1,length(cfg.stim.(sesName).(phaseName)(phaseCount).viewIndices{b}(((s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerView)-1):(s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerView)))),...
%       %  cfg.stim.(sesName).(phaseName)(phaseCount).viewIndices{b}(((s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerView)-1):(s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerView))));
%       expParam.session.(sesName).(phaseName)(phaseCount).viewStims{b} = cat(1,...
%         expParam.session.(sesName).(phaseName)(phaseCount).viewStims{b},...
%         thisSpecies_f1(cfg.stim.(sesName).(phaseName)(phaseCount).viewIndices{b}(((s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerView)-1):(s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerView))));
%     else
%       %fprintf('view f1: block %d, species %d, exemplar %d\n',b,cfg.stim.(sesName).(phaseName)(phaseCount).blockSpeciesOrder{b}(s),cfg.stim.(sesName).(phaseName)(phaseCount).viewIndices{b}(s));
%       expParam.session.(sesName).(phaseName)(phaseCount).viewStims{b} = cat(1,...
%         expParam.session.(sesName).(phaseName)(phaseCount).viewStims{b},...
%         thisSpecies_f1(cfg.stim.(sesName).(phaseName)(phaseCount).viewIndices{b}(s)));
%     end
%     
%     % add them to the naming list
%     if cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerName > 1
%       %fprintf('\tname f1: block %d, species %d, exemplar%s\n',b,cfg.stim.(sesName).(phaseName)(phaseCount).blockSpeciesOrder{b}(s),...
%       %  sprintf(repmat(' %d',1,length(cfg.stim.(sesName).(phaseName)(phaseCount).nameIndices{b}(((s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerName)-1):(s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerName)))),...
%       %  cfg.stim.(sesName).(phaseName)(phaseCount).nameIndices{b}(((s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerName)-1):(s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerName))));
%       expParam.session.(sesName).(phaseName)(phaseCount).nameStims{b} = cat(1,...
%         expParam.session.(sesName).(phaseName)(phaseCount).nameStims{b},...
%         thisSpecies_f1(cfg.stim.(sesName).(phaseName)(phaseCount).nameIndices{b}(((s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerName)-1):(s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerName))));
%     else
%       %fprintf('name f1: block %d, species %d, exemplar %d\n',b,cfg.stim.(sesName).(phaseName)(phaseCount).blockSpeciesOrder{b}(s),cfg.stim.(sesName).(phaseName)(phaseCount).nameIndices{b}(s));
%       expParam.session.(sesName).(phaseName)(phaseCount).nameStims{b} = cat(1,...
%         expParam.session.(sesName).(phaseName)(phaseCount).nameStims{b},...
%         thisSpecies_f1(cfg.stim.(sesName).(phaseName)(phaseCount).nameIndices{b}(s)));
%     end
...
%     if cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerView > 1
%       % debug
%       fprintf('\view f2: block %d, species %d, exemplar%s\n',b,cfg.stim.(sesName).(phaseName)(phaseCount).blockSpeciesOrder{b}(s),...
%        sprintf(repmat(' %d',1,length(cfg.stim.(sesName).(phaseName)(phaseCount).viewIndices{b}(((s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerView)-1):(s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerView)))),...
%        cfg.stim.(sesName).(phaseName)(phaseCount).viewIndices{b}(((s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerView)-1):(s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerView))));
%       expParam.session.(sesName).(phaseName)(phaseCount).viewStims{b} = cat(1,...
%         expParam.session.(sesName).(phaseName)(phaseCount).viewStims{b},...
%         thisSpecies_f2(cfg.stim.(sesName).(phaseName)(phaseCount).viewIndices{b}(((s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerView)-1):(s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerView))));
%     else
%       % debug
...
%       expParam.session.(sesName).(phaseName)(phaseCount).nameStims{b} = cat(1,...
%         expParam.session.(sesName).(phaseName)(phaseCount).nameStims{b},...
%         thisSpecies_f2(cfg.stim.(sesName).(phaseName)(phaseCount).nameIndices{b}(((s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerName)-1):(s*cfg.stim.(sesName).(phaseName)(phaseCount).exemplarPerName))));
%     else
%       % debug
%       fprintf('name f2: block %d, species %d, exemplar %d\n',b,cfg.stim.(sesName).(phaseName)(phaseCount).blockSpeciesOrder{b}(s),cfg.stim.(sesName).(phaseName)(phaseCount).nameIndices{b}(s));
%       expParam.session.(sesName).(phaseName)(phaseCount).nameStims{b} = cat(1,...
%         expParam.session.(sesName).(phaseName)(phaseCount).nameStims{b},...
%         thisSpecies_f2(cfg.stim.(sesName).(phaseName)(phaseCount).nameIndices{b}(s)));
%     end
