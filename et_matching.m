...
for i = trialNum:length(stim2Tex)
  ...
  if expParam.useNS
    ...
    [NSEventStatus, NSEventError] = et_NetStation('Event', 'FIXT', preStim1FixOn, .001,...
      ...
      'expt',phaseCfg.isExp,...
      'trln', int32(i), 'stmn', stim1Name, 'famn', fNum1, 'spcn', specNum1, 'snum', stim1(i).matchStimNum,...
    ...
    [NSEventStatus, NSEventError] = et_NetStation('Event', 'FIXT', preStim2FixOn, .001,...
      'subn', expParam.subject, 'sess', sesName, 'phas', phaseName, 'pcou', phaseCount,...
      'expt',phaseCfg.isExp,...
      'trln', int32(i), 'stmn', stim2Name, 'famn', fNum2, 'spcn', specNum2, 'snum', stim2(i).matchStimNum,...
