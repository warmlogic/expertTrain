...
for i = trialNum:length(stim2Tex)
  ...
  fprintf(logFile,'%f\t%s\t%s\t%s\t%i\t%i\t%s\t%i\t%s\t%s\t%i\t%i\t%i\t%i\t%i\t%i\n',...
    img1On,...
    expParam.subject,...
    sesName,...
    phaseName,...
  ...
  fprintf(logFile,'%f\t%s\t%s\t%s\t%i\t%i\t%s\t%i\t%i\t%i\t%i\t%s\t%s\t%i\t%i\n',...
    endRT,...
    expParam.subject,...
    sesName,...
    phaseName,...
  ...
  % Write stim1 presentation to file:
  fprintf(plf,'%f\t%s\t%s\t%s\t%i\t%i\t%s\t%i\t%s\t%s\t%i\t%i\t%i\t%i\t%i\t%i\n',...
    img1On,...
    expParam.subject,...
    sesName,...
    phaseName,...
  ...
  % Write trial result to file:
  fprintf(plf,'%f\t%s\t%s\t%s\t%i\t%i\t%s\t%i\t%i\t%i\t%i\t%s\t%s\t%i\t%i\n',...
    endRT,...
    expParam.subject,...
    sesName,...
    phaseName,...
  ...
  if expParam.useNS
    ...
    [NSEventStatus, NSEventError] = et_NetStation('Event', 'FIXT', preStim1FixOn, .001,...
      'subn', expParam.subject, 'sess', sesName, 'phas', phaseName, 'pcou', phaseCount,...
      'expt',phaseCfg.isExp,...
